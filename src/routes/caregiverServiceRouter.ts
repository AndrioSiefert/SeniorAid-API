...
router.get('/caregiver-service/caregiver', (req, res) => controllers.getCaregiverWithService(req, res));
router.get('/caregiver-service/id/:id', (req, res) => controllers.getById(req, res));
router.get('/caregiver-service/:id', (req, res) => controllers.getInfoService(req, res));
...
router.delete('/caregiver-service/:id', (req, res) => controllers.delete(req, res));
