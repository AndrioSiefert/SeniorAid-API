...
const serviceRequestRepository = new ServiceRequestRepository(AppDataSource.getRepository('ServiceRequestEntity'));
const controllers = new ServiceRequestController(serviceRequestRepository);

router.get('/service-request', (req, res) => controllers.getAllRequest(req, res));
